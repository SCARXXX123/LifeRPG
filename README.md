...
### 主界面 | Main Interface
<<<<<<< HEAD
![主界面](pictures/index_pic.png)

### 初始化页面 | Initialization Page
![初始化页面](pictures/initialize_pic.png)
...
### 审计报告 | Audit Report
![审计报告](pictures/report_pic.png)

### 审计后的数字化身 | Digital Avatar After Audit
![审计后的数字化身](pictures/character_after_audit_pic.png)
=======
![主界面](index_pic.png)
...
### 审计报告 | Audit Report
![审计报告](report_pic_JP.png)

### 审计后的数字化身 | Digital Avatar After Audit
![审计后的数字化身](character_after_audit_pic_JP.png)
>>>>>>> 6726a59560fb563b395b5e199e42df723eb1e8e1
